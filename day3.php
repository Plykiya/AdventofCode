    ...
    foreach ($directions as $key => $value) {
      ...
      if ($direction = 'U') {
        ...
        for ($i = $original; $i != $this->vertical; $i++) {
          ...
          $coordinates[$this->index]['horizontal'] = $this->horizontal;
          $coordinates[$this->index++]['vertical'] = $i;
        }
      } elseif ($direction = 'D') {
        $original = $this->vertical;
        $this->vertical = $this->vertical - $distance;
        ...
        for ($i = $original; $i != $this->horizontal; $i--) {
          $coordinates[$this->index]['horizontal'] = $i;
          $coordinates[$this->index++]['vertical'] = $this->vertical;
        }
      } elseif ($direction = 'R') {
        $original = $this->horizontal;
        $this->horizontal = $this->horizontal + $distance;
